...
이 폴더는 AWS 인프라 2주 프로젝트의 문서를 모으는 공간입니다.
...
- 매일 공부기록은 `docs/study-log/{name}/YYYY-MM-DD.md`에 작성합니다.
- 각자 담당 파트의 Must / Optional 범위는 `docs/must-optional/`에 정리합니다.
...
- 공부기록 템플릿: `templates/study-log-template.md`
- Must / Optional 템플릿: `templates/must-optional-template.md`
